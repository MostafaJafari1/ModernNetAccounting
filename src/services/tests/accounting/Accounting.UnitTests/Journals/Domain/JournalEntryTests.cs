...
namespace Accounting.UnitTests.Journals.Domain
{
    public class JournalEntryTests
    {
        ...
        {
            // Arrange
            var journal = JournalEntry.Create(_journalId, _testDate, "Add Line Test");
        ...
        {
            // Arrange
            var journal = JournalEntry.Create(_journalId, _testDate, "Post Entry");
        ...
        {
            // Arrange
            var journal = JournalEntry.Create(_journalId, _testDate, "Remove Line");
        ...
        {
            // Arrange
            var journal = JournalEntry.Create(_journalId, _testDate, "Remove Line which not exist");
        ...
        {
            // Arrange
            var journal = JournalEntry.Create(_journalId, _testDate, "Balanced Entry");
        ...
        {
            // Arrange
            var journal = JournalEntry.Create(_journalId, _testDate, "Unbalanced Entry");
        ...
        {
            // Arrange
            var journal = JournalEntry.Create(_journalId, _testDate, "Empty Entry");
